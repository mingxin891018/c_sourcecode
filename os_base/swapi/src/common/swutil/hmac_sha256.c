...
#define SELF_TEST
#if defined(FS_IO) || defined(SELF_TEST)
#include <stdio.h>
#endif
 ...
 * Checkup routine 
 */
int sw_sha2_self_test( int verbose )
{
	int i, j, k, buflen;
	unsigned char buf[1024];
